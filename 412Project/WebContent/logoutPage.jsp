...
<style>
    ...
    .bgimg-1 {
        background-image: url('https://i.gifer.com/XDR.gif');
        min-height: 80%;
    }
...
<div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
 <div class="w3-display-middle" style="white-space:nowrap;">
    <span class="w3-center w3-padding-large w3-red w3-xlarge w3-wide w3-animate-opacity">THAT'S ALL FOLKS</span>
  </div>
</div>

<!-- Error Section -->
<div class="w3-content w3-center w3-container w3-padding-64" id="error">
  <h3 class="w3-center">Back to Home Page</h3>
