...
<div class="w3-container w3-white w3-row-padding w3-padding-16 w3-left" id="AboutUsSec">
	...
	<p class="w3-left" style="margin:35px"> 
	Our mission is to save and shelter rabbits while increasing awareness about rabbit's health and grooming.  
	At Roger's Rabbit Roost, we strive to provide the best care and information about your favorite creatures. Whether its buying accessories such as cushions, 
	or pampering your furry buddy with a grooming clinic, Roger's Rabbit Roost is the place for you!
	Where none of you are taken for granted!</p>
</div>
