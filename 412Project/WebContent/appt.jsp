...
<title>Appointment Approval Page</title>
<style>
    ...
    .bgimg-1 {
        background-image: url('https://d2gg9evh47fn9z.cloudfront.net/800px_COLOURBOX6408420.jpg');
        min-height: 80%;
    }
...
<div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
 <div class="w3-display-middle" style="white-space:nowrap;">
    <span class="w3-center w3-padding-large w3-red w3-xlarge w3-wide w3-animate-opacity">SUCCESS!</span>
  </div>
</div>

<!-- APmt Section-->
<div class="w3-content w3-center w3-container w3-padding-64" id="error">
  <h3 class="w3-center">Your appointment was registered successfully! Please visit us at your scheduled time or any time between 10:00 AM to 4:00 PM, Monday to Friday.</h3>
  <form action="login.jsp">
    <button type="submit" class="w3-button w3-hide-small w3-red"><i class="fa fa-power-off"></i> HOME</button>
    </form></div>
